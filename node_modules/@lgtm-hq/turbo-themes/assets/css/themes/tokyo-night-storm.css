/* Generated from tokyo-night-storm.css */
...
[data-theme="tokyo-night-storm"] {
  ...
  --turbo-bg-base: #24283b; /* color */
  --turbo-bg-surface: #28344a; /* color */
  --turbo-bg-overlay: #565f89; /* color */
  --turbo-text-primary: #c0caf5; /* color */
  --turbo-text-secondary: #a9b1d6; /* color */
  --turbo-text-inverse: #24283b; /* color */
  ...
  --turbo-blockquote-bg: #28344a; /* color */
  ...
  --turbo-table-stripe: #28344a; /* color */
